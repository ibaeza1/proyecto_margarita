...
FROM(
SELECT fup.pk_dim_subscriber as  subscriber,
fup.date_created as activation_date,
...
FROM trusted.fac_using_puramente fup
LEFT JOIN trusted.dim_subscribers ds on ds.pk_dim_subscriber =fup.pk_dim_subscriber
