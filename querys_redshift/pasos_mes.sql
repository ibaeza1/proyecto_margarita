...
DATE(date_trunc('month', timezone('America/Santiago',fa.date_start) )) as month_selected
...
GROUP BY  fa.date_start ,sport,do2.name_organization, fa.pk_dim_sport, fa.pk_dim_habit,month_selected
ORDER BY organization )
select t.organization, sum(t.steps) as steps_month, t.month_selected
from todo as t
group by t.organization, t.month_selected
ORDER BY t.organization
