SELECT sum(fe.val_count) as donations, do2.name_organization as organization, dc2.name_campaign as campaign, dc2.pk_dim_campaign as id_campaign,
dc2.name_es_campaign as nombre_campana, dd.name_donationtype as type_donation,
DATE(date_trunc('month', fe.date_exchange )) as month_selected
...
and fe.date_exchange >= dc.date_start
and dc.is_invalid= false
GROUP BY organization, campaign, month_selected, campaign, id_campaign, nombre_campana, type_donation,month_selected